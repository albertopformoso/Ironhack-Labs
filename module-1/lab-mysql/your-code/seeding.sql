USE lab_mysql_apf;
INSERT INTO cars
(ID, c_vin, c_manufacturer, c_model, c_year, c_color)
...
(ID,cmr_customer_id,cmr_name,cmr_phone,cmr_email,cmr_address,cmr_city,cmr_state,cmr_country,cmr_cp)
...
(ID, sp_staff_id,sp_name,sp_store)
...
(ID,i_number,i_date,i_car,i_customer_id,i_staff_id)
